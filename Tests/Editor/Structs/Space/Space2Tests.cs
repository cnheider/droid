namespace droid.Tests.Editor.Structs.Space {
  ...
  public class Space2Tests {
    ...
    public float TestDenormalise01(float v, float min_value, float max_value) {
      var space = new droid.Runtime.Structs.Space.Space2 {
                                                             Min = UnityEngine.Vector2.one * min_value,
                                                             Max = UnityEngine.Vector2.one * max_value,
                                                             Normalised =
                                                                 droid.Runtime.Enums.ProjectionEnum.Zero_one_,
                                                             DecimalGranularity = 2
                                                         };

      return space.Reproject(v : UnityEngine.Vector2.one * v)[0];
    }
    ...
    public float TestNormalise01(float v, float min_value, float max_value) {
      ...
      return space.Project(v : UnityEngine.Vector2.one * v)[0];
    }
    ...
    public void TestDenormalise010Throws(float v) {
      var space = new droid.Runtime.Structs.Space.Space2 {
                                                             Min = 0 * UnityEngine.Vector2.one,
                                                             Max = 10 * UnityEngine.Vector2.one,
                                                             Normalised = droid.Runtime.Enums.ProjectionEnum
                                                                 .Zero_one_
                                                         };

      NUnit.Framework.Assert.That(() => space.Reproject(v : v * UnityEngine.Vector2.one),
    ...
    public void TestNormalise010Throws(float v) {
      ...
      NUnit.Framework.Assert.That(() => space.Project(v : v * UnityEngine.Vector2.one),
                                  expr : NUnit.Framework.Throws.TypeOf<System.ArgumentException>());
    }
