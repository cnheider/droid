...
public struct FlatBufferActor : IFlatbufferObject
{
  ...
  public FlatBufferPosRot? Posrot { get { int o = __p.__offset(6); return o != 0 ? (FlatBufferPosRot?)(new FlatBufferPosRot()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static void AddPosrot(FlatBufferBuilder builder, Offset<FlatBufferPosRot> posrotOffset) { builder.AddOffset(1, posrotOffset.Value, 0); }
...
public struct FlatBufferState : IFlatbufferObject
{
  ...
  public static void StartFlatBufferState(FlatBufferBuilder builder) { builder.StartObject(5); }
...
public struct FlatBufferPosRot : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static FlatBufferPosRot GetRootAsFlatBufferPosRot(ByteBuffer _bb) { return GetRootAsFlatBufferPosRot(_bb, new FlatBufferPosRot()); }
  public static FlatBufferPosRot GetRootAsFlatBufferPosRot(ByteBuffer _bb, FlatBufferPosRot obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public FlatBufferPosRot __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public FlatBufferQuat? Rotation { get { int o = __p.__offset(6); return o != 0 ? (FlatBufferQuat?)(new FlatBufferQuat()).__assign(o + __p.bb_pos, __p.bb) : null; } }

  public static void StartFlatBufferPosRot(FlatBufferBuilder builder) { builder.StartObject(2); }
  ...
  public static void AddRotation(FlatBufferBuilder builder, Offset<FlatBufferQuat> rotationOffset) { builder.AddStruct(1, rotationOffset.Value, 0); }
...
public struct FlatBufferObserver : IFlatbufferObject
{
  ...
  public FlatBufferPosRot? Posrot { get { int o = __p.__offset(8); return o != 0 ? (FlatBufferPosRot?)(new FlatBufferPosRot()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static void AddPosrot(FlatBufferBuilder builder, Offset<FlatBufferPosRot> posrotOffset) { builder.AddOffset(2, posrotOffset.Value, 0); }
