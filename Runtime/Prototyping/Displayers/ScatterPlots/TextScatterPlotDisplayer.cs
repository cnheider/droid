namespace droid.Runtime.Prototyping.Displayers.ScatterPlots {
  ...
  public class TextScatterPlotDisplayer : Displayer {
    ...
    System.Collections.Generic.List<string> _vs = new System.Collections.Generic.List<string>();
    ...
    public override void Display(double value) {
      ...
      this._Values = new[] {value.ToString(provider : System.Globalization.CultureInfo.InvariantCulture)};
    ...
    public override void Display(float[] values) {
      ...
      #endif
      this._Values = System.Linq.Enumerable.ToArray(source : System.Linq.Enumerable.Select(source : values,
                                                      v => v.ToString(provider : System.Globalization
                                                                          .CultureInfo
                                                                          .InvariantCulture)));
    ...
    public override void Display(float values) {
      ...
      this._Values = new[] {values.ToString(provider : System.Globalization.CultureInfo.InvariantCulture)};
      this.PlotSeries(this._Values);
    }
